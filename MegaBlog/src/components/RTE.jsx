...
export default function RTE({name,control,label,defaultValue=""}) {//control react-hook-form se aata hai,ye control hi responsible hai uski sare state ko usform me le jaane ke liye ;
  return (
    <div className='w-full'>
        ...
        render={({field: {onChange}}) => (
            ...
            apiKey='5ogd6gs70mdxucsdbznl50henxowwhuygze12yti94g8ub7v'
